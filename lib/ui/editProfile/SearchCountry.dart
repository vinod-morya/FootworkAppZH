...
class SearchCountry extends StatefulWidget {
  final List<CountriesListBean> countryList;
...
class SearchCountryState extends State<SearchCountry> {
  ...
  List<CountriesListBean> countryList = List<CountriesListBean>();
  List<CountriesListBean> dummyListData = List<CountriesListBean>();
  ...
  void callApiGetProjects(String query) {
    List<CountriesListBean> queryList = List<CountriesListBean>();
  ...
  Widget buildList(List<CountriesListBean> countryList) {
