...
//    print('getResponse in controller ${new DateTime.now()}---> ${widget.pos}');
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: widget.data.lastActivity != null
                                        ? '${getDate(widget.data.lastActivity,
                                        'MMMM dd, yyyy')}'
                                        : '',
                                    style: TextStyle(
                                      fontSize: widget.fit.t(9.0),
...
//                                      right: widget.fit.t(10.0),
          ...
          Container(
            ...
            child: IntrinsicHeight(
              child: Text(
                '#${widget.data.month == null ? "01" : int.parse(
                    widget.data.month) > 9
                    ? int.parse(widget.data.month)
                    : '0${int.parse(widget.data.month)}'}',
                style: TextStyle(
