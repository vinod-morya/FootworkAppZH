...
class AddEditInstaUrl extends StatefulWidget {
  final icon;
  final okBtnFunction;
  final okBtnTxt;
  final date;
  ...
  @override
  _AddEditInstaUrlState createState() => _AddEditInstaUrlState();
}

class _AddEditInstaUrlState extends State<AddEditInstaUrl> {
  String data = '';
